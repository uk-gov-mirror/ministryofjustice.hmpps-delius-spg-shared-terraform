...
${local.name} alert triggered in application log <https://eu-west-2.console.aws.amazon.com/cloudwatch/home?region=eu-west-2#logEventViewer:group=${local.log_group_name};filter=${local.pattern};${local.date_range_placeholder}|${local.log_group_name}>
