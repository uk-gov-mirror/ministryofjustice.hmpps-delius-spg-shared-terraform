...
module "ecs_cluster" {
  source       = "git::https://github.com/ministryofjustice/hmpps-terraform-modules.git//modules/ecs/ecs_cluster?ref=terraform-0.12"
...
module "app_service" {
  source                             = "git::https://github.com/ministryofjustice/hmpps-terraform-modules.git//modules/ecs/ecs_service/withloadbalancer/elb?ref=terraform-0.12"
...
module "launch_cfg" {
  source                      = "git::https://github.com/ministryofjustice/hmpps-terraform-modules.git//modules/launch_configuration/blockdevice?ref=terraform-0.12"
...
############################################
// TODO - change source to ref=terraform-0.12
module "auto_scale" {
  source               = "git::https://github.com/ministryofjustice/hmpps-terraform-modules.git//modules/autoscaling/group/default?ref=terraform-12-tags"
