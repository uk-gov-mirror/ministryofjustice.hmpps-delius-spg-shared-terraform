...
locals {
  ...
  loadbalancer_security_groups = [
    data.terraform_remote_state.security-groups-and-rules.outputs.crc_internal_loadbalancer_sg_id,
  ...
  ########################################################################################################
  ecs_service_role      = data.terraform_remote_state.iam.outputs.iam_role_crc_int_ecs_role_arn
  ...
  instance_security_groups = [
    ...
    data.terraform_remote_state.security-groups-and-rules.outputs.crc_internal_instance_sg_id,
    data.terraform_remote_state.security-groups-and-rules.outputs.crc_internal_loadbalancer_sg_id,
  ]
  ...
  instance_profile            = data.terraform_remote_state.iam.outputs.iam_policy_crc_int_app_instance_profile_name
