...
def plan_submodule(configMap, submodule_name) {
    wrap([$class: 'AnsiColorBuildWrapper', 'colorMapName': 'XTerm']) {
        ...
        docker run --rm \
            ...
            -v ~/.aws:/home/tools/.aws mojdigitalstudio/hmpps-terraform-builder-0-12:latest \
            bash -c "\
...
/*
MGB 28/2/2020
Temporarily moved to spg_deploy_elasticsearch.jenkinsfile due to the time taken to create the elk service
and the problems it causes if it fails
