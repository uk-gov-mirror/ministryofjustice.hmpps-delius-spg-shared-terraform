...
output "ecs_spg_lb_int_id" {
  value = "${module.ecs-spg.lb_int_id}"
}

output "ecs_spg_lb_int_arn" {
  value = "${module.ecs-spg.lb_int_arn}"
}

output "ecs_spg_lb_int_arn_suffix" {
  value = "${module.ecs-spg.lb_int_arn_suffix}"
}

output "ecs_spg_lb_int_dns_name" {
  value = "${module.ecs-spg.lb_int_dns_name}"
}
...
output "ecs_spg_int_target_group_id" {
  value = "${module.ecs-spg.int_target_group_id}"
}

output "ecs_spg_int_target_group_arn" {
  value = "${module.ecs-spg.int_target_group_arn}"
}

output "ecs_spg_int_target_group_arn_suffix" {
  value = "${module.ecs-spg.int_target_group_arn_suffix}"
}
...
output "ecs_spg_https_lb_int_listener_id" {
  value = "${module.ecs-spg.https_lb_int_listener_id}"
}

output "ecs_spg_https_lb_int_listener_arn" {
  value = "${module.ecs-spg.https_lb_int_listener_arn}"
}

output "ecs_spg_http_lb_int_listener_id" {
  value = "${module.ecs-spg.http_lb_int_listener_id}"
}

output "ecs_spg_http_lb_int_listener_arn" {
  value = "${module.ecs-spg.http_lb_int_listener_arn}"
}
...
output "ecs_spg_public_subnet_ids" {
  value = "${module.ecs-spg.public_subnet_ids}"
}

output "ecs_spg_private_subnet_ids" {
  value = "${module.ecs-spg.private_subnet_ids}"
}
